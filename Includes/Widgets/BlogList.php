...
class BlogList extends Widget_Base
{
	...
	{
		return esc_html__('CNV Blog List', 'cnv-school-addon');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control('layout', [
			'label'   => esc_html__('Blog Layout', 'cnv-school-addon'),
			'type'    => Controls_Manager::SELECT,
			'default' => 'one',
			'options' => [
				'one'   => esc_html__('Layout 1', 'cnv-school-addon'),
				'two'   => esc_html__('Layout 2', 'cnv-school-addon'),
				'three' => esc_html__('Layout 3', 'cnv-school-addon'),
			]
		]);
