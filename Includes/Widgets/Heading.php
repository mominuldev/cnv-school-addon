...
class Heading extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'CNV Heading', 'cnv-school-addon' );
	}
	...
	public function get_script_depends() {
		wp_enqueue_script( 'heading', CNV_PLUGIN_URL . 'assets/js/heading.js', [ 'elementor-frontend' ], '1.0.0', true );
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'section_tab', [
			'label' => esc_html__( 'Heading', 'cnv-school-addon' ),
		] );
		...
		$this->add_control( 'style', [
			...
			'default' => 'one',
			'options' => [
				'one' => esc_html__( 'Style 1', 'cnv-school-addon' ),
				'two' => esc_html__( 'Style 2', 'cnv-school-addon' ),
			]
		] );
		...
		$this->add_control( 'sub_title', [
			...
			'label_block' => true,
			'placeholder' => esc_html__( 'Sub Title', 'cnv-school-addon' ),
			'default'     => 'Sub Title',
			'separator'   => 'none',
		] );
		...
		$this->add_control( 'title_text', [
			...
			'default'     => esc_html__( 'Section Title', 'cnv-school-addon' ),
		] );


		// Secondary Title Enable
		$this->add_control( 'secondary_title_enable', [
			'label'        => __( 'Secondary Title Enable', 'cnv-school-addon' ),
		...
		$this->add_control( 'secondary_title', [
			'label'       => esc_html__( 'Secondary Title', 'cnv-school-addon' ),
			'type'        => Controls_Manager::TEXTAREA,
			'label_block' => true,
			'rows'        => 2,
			'placeholder' => esc_html__( 'Secondary Title', 'cnv-school-addon' ),
			'default'     => esc_html__( 'Secondary Title', 'cnv-school-addon' ),
			'condition'   => [
		...
		$this->add_control( 'description_text', [
			...
			'placeholder' => __( 'Type your description here', 'cnv-school-addon' ),
			'separator'   => 'before'
		] );
		...
		$this->add_responsive_control( 'heading_spacing_div', [
			'label'     => __( 'Spacing', 'cnv-school-addon' ),
		...
		$this->start_controls_section( 'section_heading_effect', [
			'label' => esc_html__( 'Heading Effects', 'designmonks-core' ),
		] );

		// Enable Splitting Effects
		$this->add_control( 'enable_splitting', [
			'label'        => __( 'Enable Splitting', 'designmonks-core' ),
			'type'         => Controls_Manager::SWITCHER,
			'label_on'     => __( 'Yes', 'designmonks-core' ),
			'label_off'    => __( 'No', 'designmonks-core' ),
			'return_value' => 'yes',
			'default'      => 'no',
		] );
		...
		$this->add_control( 'effect_style', [
			'label'     => __( 'Effect Style', 'designmonks-core' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				'one'   => 'One',
				'two'   => 'Two',
		...
		$this->add_control( 'splitting_type', [
			'label'   => __( 'Splitting Type', 'designmonks-core' ),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'chars' => 'Chars',
				'words' => 'Words',
		...
		$this->add_control( 'title_animation_time', [
			'label'     => __( 'Animation Duration', 'designmonks-core' ),
		...
		$this->start_controls_section( 'section_description_effect', [
			'label' => esc_html__( 'Description Effects', 'designmonks-core' ),
		] );
		...
		$this->add_control( 'animation_delay', [
			'label'     => __( 'Animation Delay', 'designmonks-core' ),
			'type'      => Controls_Manager::NUMBER,
			'default'   => 0.1,
			'min'       => 0.1,
			'max'       => 10,
		...
		$this->add_control( 'title_color_one', [
			'label'     => esc_html__( 'Title color', 'cnv-school-addon' ),
		...
		$this->add_responsive_control( 'space_between_title', [
			'label'     => __( 'Spacing Title', 'cnv-school-addon' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
					'min' => - 20,
		...
		$this->add_control( 'title_color_two', [
			'label'     => esc_html__( 'Secondary Title color', 'cnv-school-addon' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_control( 'subtitle_bg_color', [
			'label'     => esc_html__( 'Sub Title BG color', 'cnv-school-addon' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_control( 'circle_bg_color', [
			'label'     => esc_html__( 'Circle BG color', 'cnv-school-addon' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_responsive_control( 'space_between_subtitle', [
			'label'     => __( 'Spacing Sub Title', 'cnv-school-addon' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [
				'px' => [
					'min' => - 0,
