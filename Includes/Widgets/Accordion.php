...
class Accordion extends Widget_Base {
	...
	public function get_title() {
		return __( 'CNV Accordion', 'cnv-school-addon' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control( 'accordion_content', [
			...
			'default'    => __( 'List Content', 'cnv-school-addon' ),
			'show_label' => false,
		] );
		...
		$repeater->add_control(
			'show_icon',
			[
				'label'        => __( 'Show Icon', 'cnv-school-addon' ),
		...
		$this->add_control( 'tt-accordion', [
			'label'       => __( 'Accordion List', 'cnv-school-addon' ),
			'type'        => Controls_Manager::REPEATER,
			'fields'      => $repeater->get_controls(),
			'default'     => [
				[
					'accordion_title'   => __( 'Is SEO a risky and time consuming proposition?', 'cnv-school-addon' ),
					'accordion_content' => __( 'There are many variations of passages of Lorem Ipsum available but the majority suffered is alteration in that  words which don\'t look even slightly believable. If you are Lorem Ipsum you need to be sure there isn\'t anything ready too much embarrassing.', 'cnv-school-addon' ),
				],
				[
					'accordion_title'   => __( 'How to choose a perfect digital marketing plan?', 'cnv-school-addon' ),
					'accordion_content' => __( 'There are many variations of passages of Lorem Ipsum available but the majority suffered is alteration in that  words which don\'t look even slightly believable. If you are Lorem Ipsum you need to be sure there isn\'t anything ready too much embarrassing.', 'cnv-school-addon' ),
				],
				[
					'accordion_title'   => __( 'Is it feasible to go for a complete website audit?', 'cnv-school-addon' ),
					'accordion_content' => __( 'There are many variations of passages of Lorem Ipsum available but the majority suffered is alteration in that  words which don\'t look even slightly believable. If you are Lorem Ipsum you need to be sure there isn\'t anything ready too much embarrassing.', 'cnv-school-addon' ),
				],
				[
					'accordion_title'   => __( 'How to go about with a bespoke SMO strategy?', 'cnv-school-addon' ),
					'accordion_content' => __( 'There are many variations of passages of Lorem Ipsum available but the majority suffered is alteration in that  words which don\'t look even slightly believable. If you are Lorem Ipsum you need to be sure there isn\'t anything ready too much embarrassing.', 'cnv-school-addon' ),
				],
				[
					'accordion_title'   => __( 'Is internet marketing expensive?', 'cnv-school-addon' ),
					'accordion_content' => __( 'There are many variations of passages of Lorem Ipsum available but the majority suffered is alteration in that  words which don\'t look even slightly believable. If you are Lorem Ipsum you need to be sure there isn\'t anything ready too much embarrassing.', 'cnv-school-addon' ),
				],
			],
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'selector' => '{{WRAPPER}} .cnv-accordion .accordion-button',
		] );
		...
		$this->add_control( 'faq_title_color', [
			...
			'selectors' => [
				'{{WRAPPER}} .cnv-accordion .accordion-button.collapsed'       => 'color: {{VALUE}}',
				'{{WRAPPER}} .cnv-accordion .accordion-button.collapsed:after' => 'color: {{VALUE}}',
			],
		] );
		...
		$this->add_control( 'faq_title_active_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .cnv-accordion .accordion-button:not(.collapsed)'       => 'color: {{VALUE}}',
				'{{WRAPPER}} .cnv-accordion .accordion-button:not(.collapsed):after' => 'color: {{VALUE}}',
			],
		] );
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .cnv-accordion .accordion-button' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section( 'box_style_section', [
			'label' => __( 'Box Wrapper', 'cnv-school-addon' ),
			'tab'   => Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_control(
			'faq_margin_bottom',
			[
				'label'      => esc_html__( 'Space Between', 'cnv-school-addon' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .cnv-accordion .accordion-item:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
	...
	protected function render() {
		...
		$faq_id = 'cnv-accordion-' . substr( $this->get_id_int(), 0, 3 );
		$faq    = 'cnv-acc-' . substr( $this->get_id_int(), 0, 3 );
		$faq_o  = 'cnv-acco-' . substr( $this->get_id_int(), 0, 3 );
		?>


		<div class="cnv-accordion" id="<?php echo esc_attr( $faq_id ); ?>">
