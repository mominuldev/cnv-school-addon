...
class TestimonialCreative extends Widget_Base {
	...
	public function get_name() {
		return 'cnv-testimonial-creative';
	}

	public function get_title() {
		return esc_html__( 'CNV Testimonial Creative', 'cnv-school-addon' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control( 'layout', [
			...
			'default' => 'three',
			'options' => [
				'three' => __( 'Layout One', 'cnv-school-addon' ),
				'four' => __( 'Layout Two', 'cnv-school-addon' ),
			],
		] );
		...
		$this->add_control( 'testimonials', [
			...
			'default'     => [
				[
					...
					'review_content' => __( '"I have been using the clean gainer Multivitamin Supplement for several months now, and I am thrilled with the results. Not only has it boosted my energy levels, but it has also improved my overall well-being.', 'cnv-school-addon' ),
				],
				[
					'image'          => [
				...
				[
					...
					'name'           => __( 'Gomeza Gomedria', 'cnv-school-addon' ),
					'designation'    => __( 'UI/UX Designer', 'cnv-school-addon' ),
					'review_content' => __( '"I have been using the clean gainer Multivitamin Supplement for several months now, and I am thrilled with the results. Not only has it boosted my energy levels, but it has also improved my overall well-being.', 'cnv-school-addon' ),
				],
			],
			'title_field' => '{{{ name }}}',
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', [
			'swiper-container',
			'rbt-creative-testimonial',
		] );

		if( ! empty( $layout )) {
			$this->add_render_attribute('wrapper', 'class', 'rbt-creative-testimonial--' . $layout);
		}

		// Testimonial Style
		$this->add_render_attribute( 'testimonial', 'class', 'rbt-testimonial' );
