    ...
    <div class="post-grid style-four">
		<?php if ( has_post_thumbnail() ): ?>
            <div class="feature-image">
                <a href="<?php echo the_permalink(); ?>">
					<?php the_post_thumbnail( 'cnv_blog_grid_520x446', array( 'class' => 'img-fluid' ) ) ?>
                </a>
        ...
        <div class="blog-content">
			<?php if ( 'yes' == $settings['meta_show'] ) : ?>
                <ul class="post-meta">
                    <li class="author-simple">
						...
						<?php echo CNV_Theme_Helper::cnv_posted_by(); ?>
                    </li>
                    <li class="meta-date">
            ...
            <div class="entry-header">
                ...
                <a href="<?php the_permalink(); ?>" class="read_more_btn"><?php esc_html_e( 'Read More ', 'cnv-school-addon' ) ?></a>
            </div>
        </div>
    </div>
</div>
