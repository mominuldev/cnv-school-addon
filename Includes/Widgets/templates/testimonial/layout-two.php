					...
					<div class="swiper-slide">
						<div <?php $this->print_render_attribute_string( 'testimonial' ); ?>>
							...
							<div class="testimonial-info-wrapper">
								...
								$this->add_render_attribute( 'star-rating', 'class', 'cnv-star-rating cnv-star-' . esc_attr( $rating ) );

								$rating_markup = "<div class='cnv-star-rating cnv-star-" . $rating . "'>\n";
								$rating_markup .= "<span class=\"cnv-star-1 fa-star\"></span>\n";
								$rating_markup .= "<span class=\"cnv-star-2 fa-star\"></span>\n";
								$rating_markup .= "<span class=\"cnv-star-3 fa-star\"></span>\n";
								$rating_markup .= "<span class=\"cnv-star-4 fa-star\"></span>\n";
								$rating_markup .= "<span class=\"cnv-star-5 fa-star\"></span>\n";
								$rating_markup .= "</div>";
